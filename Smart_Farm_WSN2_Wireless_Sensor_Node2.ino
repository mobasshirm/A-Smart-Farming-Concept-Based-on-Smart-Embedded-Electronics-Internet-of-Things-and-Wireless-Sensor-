...
const uint16_t node_WSN02 = 02;                //Address of this node (in Octal format)
const uint16_t CN = 00;                        //Address of the central node
const unsigned long interval = 20;             //How often to transmit data to the central node
...
//Initialization code for nRF24L01 Module
  SPI.begin();
  radio.begin();
  network.begin(90, node_WSN02);                  //(Channel, Node address)
